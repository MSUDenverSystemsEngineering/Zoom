...
Try {
	...
	[string]$appVersion = '5.12.8 (10232)'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '11/18/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-MSI -Action 'Install' -Path "$dirFiles\ZoomInstallerFull.msi" -Parameters "/quiet /qn /norestart zConfig=`"AU2_EnableShowZoomUpdates=1;AU2_EnableUpdateAvailableBanner=1;AU2_EnableManualUpdate=1;`"" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'zoom,zwebview2agent' -CloseAppsCountdown 60
